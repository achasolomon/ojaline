...
const BENEFITS: { icon: IconName; title: string; sub: string }[] = [
  { icon: 'bolt', title: 'Instant Delivery', sub: 'As fast as 30 mins' },
  { icon: 'calendar', title: 'Scheduled Delivery', sub: 'Choose your time' },
  { icon: 'leaf', title: 'Direct from Farm', sub: 'Farm fresh produce' },
  { icon: 'refresh', title: 'Easy Returns', sub: 'Hassle-free returns' },
];

export function ServiceBenefits() {
  return (
    <section className="max-w-[1200px] mx-auto px-6 mt-3.5">
